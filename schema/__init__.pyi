...
class And:
    ...
    @property
    def args(self) -> Any: ...
    def validate(self, data: T) -> Union[T, Any]: ...
...
class Schema:
    ...
    @overload
    def __init__(self, schema: Any, error: Errors = ..., ignore_extra_keys: bool = ..., name: str = ..., description: _Optional[str] = ..., as_reference: _Literal[True] = ...) -> None: ...
    @overload
    def __init__(self, schema: Any, error: Errors = ..., ignore_extra_keys: bool = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., as_reference: _Literal[False] = ...) -> None: ...
    @property
    def schema(self) -> Any: ...
    @property
